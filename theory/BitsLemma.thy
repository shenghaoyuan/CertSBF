...
lemma bits_zero_ext_u8 [simp]: " 0 \<le> i \<Longrightarrow>
...
lemma bits_shl_u8 [simp]: "0 \<le> i \<Longrightarrow> i < 8 \<Longrightarrow>
...
lemma bits_two_p_m1_u8 [simp]: "n \<le> 8 \<Longrightarrow>
